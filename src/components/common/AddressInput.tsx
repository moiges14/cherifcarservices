...
const AddressInput: React.FC<AddressInputProps> = ({
  ...
  useEffect(() => {
    ...
    const initializeGooglePlaces = async () => {
      // Vérifier si Google Maps est déjà chargé par le composant parent
      if (window.google && window.google.maps && window.google.maps.places) {
        ...
        console.warn('Google Maps API non disponible. Assurez-vous qu\'il est chargé par le composant parent.');
      }
    };
